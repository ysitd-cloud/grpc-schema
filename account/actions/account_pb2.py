...
_GETUSERINFOREQUEST = _descriptor.Descriptor(
  ...
  full_name='account.GetUserInfoRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='username', full_name='account.GetUserInfoRequest.username', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETUSERINFOREPLY = _descriptor.Descriptor(
  ...
  full_name='account.GetUserInfoReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='exists', full_name='account.GetUserInfoReply.exists', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='user', full_name='account.GetUserInfoReply.user', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETTOKENINFOREQUEST = _descriptor.Descriptor(
  ...
  full_name='account.GetTokenInfoRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='token', full_name='account.GetTokenInfoRequest.token', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETTOKENINFOREPLY = _descriptor.Descriptor(
  name='GetTokenInfoReply',
  full_name='account.GetTokenInfoReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='exists', full_name='account.GetTokenInfoReply.exists', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='token', full_name='account.GetTokenInfoReply.token', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETUSERINFOREPLY.fields_by_name['user'].message_type = account_dot_models_dot_types__pb2._USER
_GETTOKENINFOREPLY.fields_by_name['token'].message_type = account_dot_models_dot_types__pb2._TOKEN
...
DESCRIPTOR.message_types_by_name['GetTokenInfoReply'] = _GETTOKENINFOREPLY
...
GetUserInfoRequest = _reflection.GeneratedProtocolMessageType('GetUserInfoRequest', (_message.Message,), dict(
  ...
  __module__ = 'account.actions.account_pb2'
  # @@protoc_insertion_point(class_scope:account.GetUserInfoRequest)
  ))
_sym_db.RegisterMessage(GetUserInfoRequest)

GetUserInfoReply = _reflection.GeneratedProtocolMessageType('GetUserInfoReply', (_message.Message,), dict(
  DESCRIPTOR = _GETUSERINFOREPLY,
  __module__ = 'account.actions.account_pb2'
  # @@protoc_insertion_point(class_scope:account.GetUserInfoReply)
  ))
...
GetTokenInfoRequest = _reflection.GeneratedProtocolMessageType('GetTokenInfoRequest', (_message.Message,), dict(
  ...
  __module__ = 'account.actions.account_pb2'
  # @@protoc_insertion_point(class_scope:account.GetTokenInfoRequest)
  ))
_sym_db.RegisterMessage(GetTokenInfoRequest)

GetTokenInfoReply = _reflection.GeneratedProtocolMessageType('GetTokenInfoReply', (_message.Message,), dict(
  DESCRIPTOR = _GETTOKENINFOREPLY,
  __module__ = 'account.actions.account_pb2'
  # @@protoc_insertion_point(class_scope:account.GetTokenInfoReply)
  ))
_sym_db.RegisterMessage(GetTokenInfoReply)
